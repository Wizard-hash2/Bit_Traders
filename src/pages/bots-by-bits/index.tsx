...
import BotCard from '../pro-bot/bot-card';
import '../pro-bot/pro-bot.scss';

const BotsByBits = observer(() => {
            ...
            <div className='pro-bot__header'>
                <div className='pro-bot__header-text'>
                    ...
                    <p className='pro-bot__subtitle'>
                        <Localize i18n_default_text='Explore our curated collection of 87 trading strategies - browse, search, and load instantly!' />
                    </p>
                </div>
